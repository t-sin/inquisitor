...
(subtest "encoding -- not supported scheme"
  (is-error (test-enc "data/empty.txt" :not-supported :utf8) 'error))

(subtest "encoding -- jp"
  (test-enc "data/ascii/empty.txt" :jp :utf8)
  (test-enc "data/ascii/ascii.txt" :jp :utf8)

  (test-enc "data/ja/eucjp.txt" :jp :euc-jp)
  (test-enc "data/ja/jis.txt" :jp :iso-2022-jp)
  (test-enc "data/ja/sjis.txt" :jp :cp932)

  (test-enc "data/unicode/utf8.txt" :jp :utf8)
  (test-enc "data/unicode/ucs2be.txt" :jp :ucs-2be)
  (test-enc "data/unicode/ucs2le.txt" :jp :ucs-2le)
  (test-enc "data/unicode/utf16.txt" :jp :utf16))

(subtest "encoding -- tw"
  (test-enc "data/ascii/empty.txt" :tw :utf8)
  (test-enc "data/ascii/ascii.txt" :tw :utf8)
  ...
  (test-enc "data/unicode/utf8.txt" :tw :utf8))

(subtest "encoding -- cn"
  (test-enc "data/ascii/empty.txt" :cn :utf8)
  (test-enc "data/ascii/ascii.txt" :cn :utf8)
  ...
  (test-enc "data/unicode/utf8.txt" :cn :utf8))

(subtest "encoding -- kr"
  (test-enc "data/ascii/empty.txt" :kr :utf8)
  (test-enc "data/ascii/ascii.txt" :kr :utf8)

  (test-enc "data/kr/euckr.txt" :kr :euc-kr)
  (test-enc "data/kr/johab.txt" :kr :johab)
  (test-enc "data/kr/iso2022kr.txt" :kr :iso-2022-kr)

  (test-enc "data/unicode/utf8.txt" :kr :utf8))

(subtest "encoding -- ar"
  (test-enc "data/ascii/empty.txt" :ar :utf8)
  (test-enc "data/ascii/ascii.txt" :ar :utf8)

  (test-enc "data/ar/iso8859-6.txt" :ar :iso-8859-6)
  (test-enc "data/ar/cp1256.txt" :ar :cp1256)

  (test-enc "data/unicode/utf8.txt" :ar :utf8))

(subtest "encoding -- gr"
  (test-enc "data/ascii/empty.txt" :gr :utf8)
  (test-enc "data/ascii/ascii.txt" :gr :utf8)
  ...
  (test-enc "data/unicode/utf8.txt" :gr :utf8))
...
(subtest "encoding -- tr"
  (test-enc "data/ascii/empty.txt" :tr :utf8)
  (test-enc "data/ascii/ascii.txt" :tr :utf8)

  (test-enc "data/tr/iso8859-9.txt" :tr :iso-8859-9)
  (test-enc "data/tr/cp1254.txt" :tr :cp1254)

  (test-enc "data/unicode/utf8.txt" :tr :utf8))

(subtest "encoding -- ru"
  (test-enc "data/ascii/empty.txt" :ru :utf8)
  (test-enc "data/ascii/ascii.txt" :ru :utf8)
  ...
  (test-enc "data/unicode/utf8.txt" :ru :utf8))

(subtest "encoding -- pl"
  (test-enc "data/ascii/empty.txt" :pl :utf8)
  (test-enc "data/ascii/ascii.txt" :pl :utf8)

  (test-enc "data/pl/iso8859-2.txt" :pl :iso-8859-2)
  (test-enc "data/pl/cp1250.txt" :pl :cp1250)

  (test-enc "data/unicode/utf8.txt" :pl :utf8))

(subtest "encoding -- bl"
  (test-enc "data/ascii/empty.txt" :bl :utf8)
  (test-enc "data/ascii/ascii.txt" :bl :utf8)

  (test-enc "data/bl/iso8859-13.txt" :bl :iso-8859-13)
  (test-enc "data/bl/cp1257.txt" :bl :cp1257)

  (test-enc "data/unicode/utf8.txt" :bl :utf8))
